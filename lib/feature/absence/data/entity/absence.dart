...
class AbsenceEntity implements ToModel<Absence> {
  ...
  Absence toModel() => Absence(
        ...
        createdAt: createdAt?.mapTo(DateTime.tryParse)?.toLocal(),
        rejectedAt: rejectedAt?.mapTo(DateTime.tryParse)?.toLocal(),
        confirmedAt: confirmedAt?.mapTo(DateTime.tryParse)?.toLocal(),
